...
let summary = `Summary: "The Story"\ncosts ${costInCents.toFixed(2)} cents before tax, and final price after 10% tax is ${finalPrice.toFixed(2)} cents.`;

// Display in HTML
document.getElementById("message-output").textContent = summary;